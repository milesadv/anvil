...
export function CaseStudyContent({ slug }: CaseStudyContentProps) {
        ...
        >
          ...
          <div className="space-y-5 text-sm sm:text-base font-normal leading-[1.85]">
            {caseStudy.challenges.map((challenge) => (
              <TextWithParticles key={challenge} className="text-white/45 hover:text-white/65 transition-colors duration-700">
                <p>{challenge}</p>
              </TextWithParticles>
            ))}
          </div>
        ...
        >
          ...
          <div className="space-y-5 text-sm sm:text-base font-normal leading-[1.85]">
            {caseStudy.whatWeBuilt.map((item) => (
              <TextWithParticles key={item} className="text-white/45 hover:text-white/65 transition-colors duration-700">
                <p>{item}</p>
              </TextWithParticles>
            ))}
          </div>
        ...
        >
          ...
          {metricsWithoutValues.length > 0 && (
            <div className="space-y-4">
              {metricsWithoutValues.map((item) => (
                <TextWithParticles key={item.original} className="text-white/45 hover:text-white/65 transition-colors duration-700">
                  <p className="text-sm sm:text-base font-normal leading-[1.85]">
                    {item.original}
                  </p>
                </TextWithParticles>
