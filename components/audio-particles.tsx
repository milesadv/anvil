...
export function AudioParticles({ audioData }: AudioParticlesProps) {
      ...
      new THREE.ShaderMaterial({
        ...
        vertexShader: `
          ...
          void main() {
            ...
            // =====================================================
            // AUDIO-REACTIVE FLOW - liquid motion on the surface
            // =====================================================
            ...
            // Store world position for color calculation
            ...
            // =====================================================
            // GLITCH EFFECT - subtle digital distortion
            // =====================================================
            ...
            // Point size - audio reactive with glitch flicker
        ...
        fragmentShader: `
          ...
          // Hash function for glitch randomness
          float hash(float n) {
            return fract(sin(n) * 43758.5453123);
          }
          ...
          vec3 getIridescentColor(vec3 worldPos, vec3 normal, float time) {
            ...
            // Red/warm tones as primary palette
            ...
            // Moving red zones across the surface
            ...
            // Beat flash - white-hot with red edge
  ...
  useFrame((state) => {
    if (pointsRef.current && materialRef.current) {
      ...
      materialRef.current.uniforms.uMid.value = audioData.mid
      materialRef.current.uniforms.uHigh.value = audioData.high
      materialRef.current.uniforms.uBeat.value = audioData.beat
      materialRef.current.uniforms.uVolume.value = audioData.volume
      ...
      materialRef.current.uniforms.uLowpassIntensity.value = lowpassIntensity
      materialRef.current.uniforms.uHighpassIntensity.value = highpassIntensity
    }
  })
